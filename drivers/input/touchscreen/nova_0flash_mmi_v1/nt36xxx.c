...
#if !IS_ENABLED(CONFIG_INPUT_TOUCHSCREEN_MMI_NVT)
...
#if defined (NVT_SENSOR_EN) || IS_ENABLED(CONFIG_INPUT_TOUCHSCREEN_MMI_NVT)
...
#if ((LINUX_VERSION_CODE >= KERNEL_VERSION(5, 4, 0)) || defined(NVT_CONFIG_DRM_PANEL)) &&\
	!IS_ENABLED(CONFIG_INPUT_TOUCHSCREEN_MMI_NVT)
...
#endif //#ifndef CONFIG_INPUT_TOUCHSCREEN_MMI_NVT
